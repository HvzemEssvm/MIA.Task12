...
import rospy
from geometry_msgs.msg import Twist                   #for controlling the robot’s linear and angular velocity.
from nav_msgs.msg import Odometry                     #to get the robot's position and orientation.
from tf.transformations import euler_from_quaternion  #converts the robot’s orientation to (Roll, Pitch, Yaw)
...
# Function to Applying PID Controlling on Linear and Angular 
def Apply_pid():
